 ...
 * @author Quang Trung
 */
@WebServlet(name = "AdminCreateFlight", urlPatterns = {"/admin/createFlight"})
public class AdminCreateFlight extends HttpServlet {
    @EJB
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet AdminCreateFlight</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet AdminCreateFlight at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        request.setAttribute("listairports", airports);
        request.getRequestDispatcher("/admin/createFlight.jsp").forward(request, response);
    }
